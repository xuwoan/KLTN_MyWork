...
export default class Employer_Setting extends Component {
                ...
                <Content style={{ backgroundColor: 'white' }}>
                    ...
                    <View style={{ backgroundColor: '#DFDFDF', marginLeft: 5, marginRight: 5, height: HEIGHT }}>
                        <Item fixedLabel style={{
                            ...
                            <Text style={{ marginLeft: 5, fontSize: 17, color: 'black', fontStyle: 'italic' }}>Nhận CV từ ứng viên:</Text>
                            <View style={{ position: 'absolute', right: 0 }}>
                                <Switch
                                    ...
                                    switchHeight={28}
                                    switchWidth={50}
                                    active={this.props.user.detailemployer.setting.receivecv_noti}
                                    onActivate={() => {

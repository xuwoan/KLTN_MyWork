...
export default class Employer_WorkScreen extends Component {
    ...
    renderScrollViewContent() {
        console.log("PPP",this.props.param)

        return (
            <View style={{ marginTop: 78, margin: 1 ,height:HEIGHT-153,marginBottom:40 }}>
                            ...
                            onEndReached={() =>{ 
                                ...
                                this.setState(prevState => ({
                                 ...
                                 setTimeout(()=>{
                                     ...
                                     this.props.onFetchFilterRecruiment(this.state.param)},200);
                                 }
                            }}
        ...
        return (
            ...
            <Container>
                ...
                <View style={{ flex: 1, backgroundColor: '#FDFEFE' }}>
                    ...
                    >
                        ...
                        <Input
                            ...
                            onChangeText={(text) => {
                                ...
                                setTimeout(()=>{this.props.onFetchFilterRecruiment(this.state.param)},250)
                            }
                            }
                    ...
                    >
                        <TouchableOpacity style={{ marginBottom: 5,marginRight: 5,marginLeft: 5,marginTop: 1, flex: 0.5 }} onPress={this.gotoQuickFilter}>
                        ...
                        <TouchableOpacity style={{ marginBottom: 5,marginRight: 5,marginLeft: 5,marginTop: 1, flex: 0.5 }} onPress={this.gotoFilter}>
                            <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', }}>
                        ...
                        <TouchableOpacity style={{ marginBottom: 5,marginRight: 5,marginLeft: 5,marginTop: 1, flex: 0.5 }} onPress={this.gotoDefault}>
                            <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>

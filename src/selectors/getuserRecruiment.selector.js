...
export const getIsLoadingListUserRecruiment = (state) => state.UserRecruiment.isLoadingUserRecruiment;
...
export const getIsLoadingDetailUserRecruiment = (state) => state.UserRecruiment.isLoadingDetailRecruiment
